...
public class CommonsMultipartResolver extends CommonsFileUploadSupport
	...
	// 处理懒加载，如果为true，会将解析请求的操作放在DefaultMultipartHttpServletRequest的initializeMultipart方法中，
	// 只有在实际调用的时候才会被调用
	// 如果为false，那么会先调用parseRequest方法来处理request请求，然后将处理的结果放到DefaultMultipartHttpServletRequest
